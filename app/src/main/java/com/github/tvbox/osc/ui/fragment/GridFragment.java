...
public class GridFragment extends BaseLazyFragment {
    ...
    private void initData() {
        ...
        scrollTop();
        toggleFilterStatus();
        sourceViewModel.getList(sortData, page);   // 直接拉取内置源的频道
    }
